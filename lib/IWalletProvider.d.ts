...
export default interface IWalletProvider {
    ...
    /**
     * Returns the wallet address list. Address format is Rpg2Addr.
     * @example
     ...
     * > ["rpgcoin:qrsy0xwugcajsqa...", "rpgcoin:qrsfpepw3egqq4k..."]
     ...
     *       'outputIndex' : 0,
     *       'address' : 'rpgcoin:qrsy0xwugcajsqa99c9nf05pz7ndckj55ctlsztu2p',
     ...
     *   "rpgtest:qq28xgrzkdyeg5vf7tp2s3mvx8u95zes5cf7wpwgux",
     ...
     * @returns The signed data. Rpgcoin signatures are serialized in the DER format over the wire.
    ...
    /**
     * Returns the Rpgcoin protocol version.
     * @example
